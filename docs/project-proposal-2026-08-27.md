...
| 方案版本 | v1.0；实现状态以 2026-08-27 核查的 `f21359f` 为基线 |
...
本方案的后续交付范围以 M1–M4 为准。[原路线图](roadmap.md)中的 Phase 历史用于追溯；CandidateRunner、72 样本扩展及其他算法路线不是本版交付前置条件，后续由 Planner 同步当前执行入口。
