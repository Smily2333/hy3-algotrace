...
int main(int argc,char**argv){
 try{
    ...
    if(cmd=="call"&&argc==6){
        ...
        auto prompt=render(req,read("prompts/hy3-interactive-diagnosis-v2.md"),read("prompts/hy3-greedy-evaluation-v1.md"));
        ...
        record["base_template_sha256"]=hy3::sha256_hex(read("prompts/hy3-interactive-diagnosis-v2.md"));
        record["extension_template_sha256"]=hy3::sha256_hex(read("prompts/hy3-greedy-evaluation-v1.md"));
    ...
    if(cmd=="export"&&argc==4){
        ...
        auto base=read("prompts/hy3-interactive-diagnosis-v2.md"),ext=read("prompts/hy3-greedy-evaluation-v1.md");
